...
#ifndef _OE_OFFSCREEN_FRAME_H_
#define _OE_OFFSCREEN_FRAME_H_
 ...
 * Short description.
 *
 * @class OffscreenFrame OffscreenFrame.h ons/VNCServer/Display/OffscreenFrame.h
 */
class OffscreenFrame : public IFrame {
private:
